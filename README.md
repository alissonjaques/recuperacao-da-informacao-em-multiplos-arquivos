# Indexador e Recuperador de Documentos
...
A pesquisa booleana foi construida com base na biblioteca Apache Lucene. Esta biblioteca fornece diversas ferramentas para indexação e consultas de arquivos em documentos. A pesquisa Probabilista, bem como a pesquisa no Espaço Vetorial, seguem estritamento o exposto nessas teorias, ou seja, são aplicadas fórmulas para o Cálculo do TF/IDF, e entre outros, baseando-se nas fórmulas prevists por esses modelos. A base de dados, documentos na extensão .htm, está zipada e deve ser colocada no seguinte diretório do projeto: "src/arquivosHTML".
